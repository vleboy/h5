window.skins={};
	...
	_proto._Group1_i = function () {
		...
		t.x = -10;
		t.y = -846;
		t.elementsContent = [this._Image26_i(),this._Image27_i(),this._Image28_i(),this._Image29_i(),this._Image30_i(),this._Image31_i(),this._Image32_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.x = 46;
		t.y = -559;
		t.elementsContent = [this._Image33_i(),this._Image34_i(),this._Image35_i(),this._Image36_i(),this._Image37_i(),this._Image38_i(),this._Image39_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.x = -81;
		t.y = -287;
		t.elementsContent = [this._Image40_i(),this._Image41_i(),this._Image42_i(),this._Image43_i(),this._Image44_i(),this._Image45_i(),this._Image46_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.x = 10;
		t.y = 17;
		t.elementsContent = [this._Image47_i(),this._Image48_i(),this._Image49_i(),this._Image50_i(),this._Image51_i(),this._Image52_i(),this._Image53_i()];
		return t;
	};
	...
	function gameSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","bgFree","borderGroup","tileMask","border2","border3","border4","freeCoinsGroup","freeEffectGroup","tile0","tile1","tile2","tile3","tile4","tile5","tile6","tile7","tile8","tile9","tile10","tile11","tile12","tile13","tile14","valueTiles","vagueTile0","vagueTile1","vagueTile2","vagueTile3","vagueTile4","vagueTile5","vagueTile6","vagueTile7","vagueTile8","vagueTile9","vagueTile10","vagueTile11","vagueTile12","vagueTile13","vagueTile14","vagueTile15","vagueTile16","vagueTile17","vagueTile18","vagueTile19","vagueTiles","particleBg","winGridGroup","bonusEffectGroup","particleGroup","tileGroup","title_fire","title","freeChooseCountTxt","freeChooseCount","lineWinTxt","freeCountBg","freeMulti","freeMultiGroup","contentGroup","bottomBar","topBar","testInput","bigwinTxt","bigWinGroup","freeChangeMc","freeChangeImg","freeChanceGroup","freeChooseCountBoom","bigWin","setting","freeChoose","freeTotalWin","gameMask","rull","tips","connectTip"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.bg_i(),this.bgFree_i(),this.contentGroup_i(),this.bottomBar_i(),this.topBar_i(),this.testInput_i(),this.bigWinGroup_i(),this.freeChanceGroup_i(),this.freeChooseCountBoom_i(),this.bigWin_i(),this.setting_i(),this.freeChoose_i(),this.freeTotalWin_i(),this.gameMask_i(),this.rull_i(),this.tips_i(),this.connectTip_i()];
	}
	...
	_proto.contentGroup_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1396;
		t.elementsContent = [this.borderGroup_i(),this.tileMask_i(),this.tileGroup_i(),this._Image2_i(),this.title_fire_i(),this.title_i(),this.freeChooseCount_i(),this.lineWinTxt_i(),this.freeCountBg_i(),this.freeMultiGroup_i()];
		return t;
	};
	...
	_proto._Image1_i = function () {
		...
		t.height = 700;
		t.horizontalCenter = 0;
		t.scale9Grid = new egret.Rectangle(33,19,204,644);
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "columBg_png";
		t.width = 1334;
		t.x = 4;
		t.y = 205;
		return t;
	...
	_proto.title_fire_i = function () {
		var t = new game.AMovieClip();
		this.title_fire = t;
		t.height = 179;
		t.horizontalCenter = 0;
		t.source = "title_fire1_png";
		t.sources = "title_fire|1-10|_png";
		t.speed = 6;
		t.visible = false;
		t.width = 450;
		t.y = 35;
	...
	_proto.title_i = function () {
		...
		t.horizontalCenter = 0;
		t.source = "title1_png";
		t.sources = "title|1-22|_png";
		t.speed = 8;
		t.y = 105;
		return t;
	};
	_proto.freeChooseCount_i = function () {
		var t = new eui.Group();
		this.freeChooseCount = t;
		t.height = 58;
		t.width = 232;
		t.x = 1354;
		t.y = 112;
		t.elementsContent = [this._Image3_i(),this._Image4_i(),this.freeChooseCountTxt_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
