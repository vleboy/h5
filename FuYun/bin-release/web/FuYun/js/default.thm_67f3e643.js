window.skins={};
                ...
                generateEUI.skins = {"eui.Button":"resource/skins/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/skins/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/skins/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/skins/eui_skins/HSliderSkin.exml","eui.Panel":"resource/skins/eui_skins/PanelSkin.exml","eui.TextInput":"resource/skins/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/skins/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/skins/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/skins/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/skins/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/skins/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/skins/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/skins/eui_skins/ItemRendererSkin.exml"};generateEUI.paths['resource/skins/game_skins/bigWinSkin.exml'] = window.bigWinSkin = (function (_super) {
	...
	function freeChooseSkin() {
		_super.call(this);
		this.skinParts = ["rect","choose20","choose15","choose10","choose8","choose5","chooseGroup","tipTxt"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.chooseGroup_i(),this.tipTxt_i()];
	}
	...
	_proto.choose15_i = function () {
		...
		t.width = 517;
		t.y = 134;
		t.elementsContent = [this._Image9_i(),this._Image10_i(),this._Image11_i(),this._Image12_i(),this._Image13_i(),this._Image14_i(),this._Image15_i(),this._Image16_i()];
		return t;
	};
	...
	_proto.choose10_i = function () {
		...
		t.width = 517;
		t.y = 134;
		t.elementsContent = [this._Image17_i(),this._Image18_i(),this._Image19_i(),this._Image20_i(),this._Image21_i(),this._Image22_i(),this._Image23_i(),this._Image24_i()];
		return t;
	};
	...
	_proto.choose8_i = function () {
		...
		t.width = 517;
		t.y = 512;
		t.elementsContent = [this._Image25_i(),this._Image26_i(),this._Image27_i(),this._Image28_i(),this._Image29_i(),this._Image30_i(),this._Image31_i(),this._Image32_i()];
		return t;
	};
	...
	_proto.choose5_i = function () {
		...
		t.width = 517;
		t.y = 512;
		t.elementsContent = [this._Image33_i(),this._Image34_i(),this._Image35_i(),this._Image36_i(),this._Image37_i(),this._Image38_i(),this._Image39_i(),this._Image40_i()];
		return t;
	};
	...
	function gameSceneSkin() {
		_super.call(this);
		this.skinParts = ["bg","bgBtm","bgTop","knotLeft","knotRight","kuang","title","freeTitle","borderGroup","tileMask","border2","border3","border4","freeCoinsGroup","freeEffectGroup","tile0","tile1","tile2","tile3","tile4","tile5","tile6","tile7","tile8","tile9","tile10","tile11","tile12","tile13","tile14","valueTiles","vagueTile0","vagueTile1","vagueTile2","vagueTile3","vagueTile4","vagueTile5","vagueTile6","vagueTile7","vagueTile8","vagueTile9","vagueTile10","vagueTile11","vagueTile12","vagueTile13","vagueTile14","vagueTile15","vagueTile16","vagueTile17","vagueTile18","vagueTile19","vagueTiles","particleBg","winGridGroup","bonusEffectGroup","particleGroup","tileGroup","lineWinTxt","freeCountBg","freeChooseCountBg","freeChooseCountTxt","freeMulti","freeMultiGroup","contentGroup","bottomBar","topBar","testInput","bigwinTxt","bigWinGroup","freeChangeMc","freeChangeImg","freeChanceGroup","freeChooseCountBoom","bigWin","setting","freeChoose","freeTotalWin","gameMask","rull","yun3","yun4","yun1","yun2","yun5","yun6","sceneChangeGroup","tips","connectTip"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.bg_i(),this.bgBtm_i(),this.bgTop_i(),this.knotLeft_i(),this.knotRight_i(),this.contentGroup_i(),this.bottomBar_i(),this.topBar_i(),this.testInput_i(),this.bigWinGroup_i(),this.freeChanceGroup_i(),this.freeChooseCountBoom_i(),this.bigWin_i(),this.setting_i(),this.freeChoose_i(),this.freeTotalWin_i(),this.gameMask_i(),this.rull_i(),this.sceneChangeGroup_i(),this.tips_i(),this.connectTip_i()];
	}
	...
	_proto.bg_i = function () {
		...
		this.bg = t;
		t.percentHeight = 100;
		t.source = "normalbg_png";
		t.percentWidth = 100;
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.bgBtm_i = function () {
		var t = new eui.Image();
		this.bgBtm = t;
		t.bottom = 0;
		t.horizontalCenter = 0;
		t.source = "normalBgBtm_png";
		t.percentWidth = 100;
		return t;
	};
	_proto.bgTop_i = function () {
		var t = new eui.Image();
		this.bgTop = t;
		t.height = 102;
		t.horizontalCenter = 0;
		t.source = "normalBgTop_png";
		t.top = 110;
		t.width = 1663;
		return t;
	};
	_proto.knotLeft_i = function () {
		var t = new eui.Image();
		this.knotLeft = t;
		t.left = 55;
		t.source = "ChineseKnot_png";
		t.top = 160;
		return t;
	};
	_proto.knotRight_i = function () {
		var t = new eui.Image();
		this.knotRight = t;
		t.right = 55;
		t.source = "ChineseKnot_png";
	...
	_proto.borderGroup_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.kuang_i(),this.title_i(),this.freeTitle_i()];
		return t;
	};
	...
	_proto.title_i = function () {
		...
		t.horizontalCenter = 0;
		t.source = "title1_png";
		t.sources = "title|1-60|_png";
		t.speed = 8;
		t.width = 634;
		t.y = 68;
		return t;
	};
	_proto.freeTitle_i = function () {
		var t = new eui.Image();
		this.freeTitle = t;
		t.height = 130;
		t.horizontalCenter = 5;
		t.source = "freeTitle_png";
		t.visible = false;
		t.width = 250;
		t.y = 67;
		return t;
	...
	_proto.sceneChangeGroup_i = function () {
		var t = new eui.Group();
		this.sceneChangeGroup = t;
		t.height = 1080;
		t.visible = false;
		t.width = 1920;
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.yun3_i(),this.yun4_i(),this.yun1_i(),this.yun2_i(),this.yun5_i(),this.yun6_i()];
		return t;
	};
	...
	var rullSkin$Skin16 = 	(function (_super) {
		__extends(rullSkin$Skin16, _super);
		function rullSkin$Skin16() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = rullSkin$Skin16.prototype;
		...
		return rullSkin$Skin16;
	})(eui.Skin);

	var rullSkin$Skin17 = 	(function (_super) {
		__extends(rullSkin$Skin17, _super);
		function rullSkin$Skin17() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = rullSkin$Skin17.prototype;
	...
	function rullSkin() {
		_super.call(this);
		this.skinParts = ["groupRull0","pageTxt_0_0","pageTxt_0_1","pageTxt_0_2","pageTxt_1_0","pageTxt_1_1","pageTxt_1_2","pageTxt_2_0","pageTxt_2_1","pageTxt_2_2","pageTxt_3_0","pageTxt_3_1","pageTxt_3_2","pageTxt_4_0","pageTxt_4_1","pageTxt_4_2","groupRull1","pageTxt_5_0","pageTxt_5_1","pageTxt_5_2","pageTxt_6_0","pageTxt_6_1","pageTxt_6_2","pageTxt_7_0","pageTxt_7_1","pageTxt_7_2","pageTxt_8_0","pageTxt_8_1","pageTxt_8_2","pageTxt_9_0","pageTxt_9_1","pageTxt_9_2","pageTxt_10_0","pageTxt_10_1","pageTxt_10_2","groupRull2","groupRull3","groupRull4","groupRull5","groupRull","ruleScroll","groupMove","btnRull0","btnRull1","btnRull2","btnRull3","btnRull4","btnRull5","btnRull","btnClose","groupOut"];
	...
	_proto.groupOut_i = function () {
		...
		t.top = 0;
		t.percentWidth = 100;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this.ruleScroll_i(),this.groupMove_i(),this.btnRull_i(),this.btnClose_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._Image3_i = function () {
		var t = new eui.Image();
		t.right = 60;
		t.source = "normalTitle_png";
		t.top = 65;
		return t;
	};
	_proto.ruleScroll_i = function () {
		var t = new eui.Group();
		this.ruleScroll = t;
		t.height = 1080;
		t.width = 1;
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.groupRull_i()];
		return t;
	};
	...
	var topBarSkin$Skin27 = 	(function (_super) {
		__extends(topBarSkin$Skin27, _super);
		function topBarSkin$Skin27() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = topBarSkin$Skin27.prototype;
